...
REPO_ROOT = Path(os.environ.get("CLAUDE_PLUGIN_ROOT", Path(__file__).resolve().parents[3]))
FALLBACK_SESSION_PATH = Path(os.environ.get("CLAUDE_PROJECT_DIR", ".")) / ".trtc-session.yaml"
